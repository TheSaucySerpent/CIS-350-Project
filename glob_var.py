...
pistol = Weapon("Pistol", 10, .5, 2, 1000, 2, mc)
ar = Weapon("Assault Rifle", 15, 1, 5, 1000, 1, mc)
dev_gun = Weapon("God's Draco", 100, 5, 10, 10000, 0, mc)
...
enemy3 = Enemy(700, 600, 50, 50, .25, 50, 10, pistol, mc)
